variable "account_name" {
  type        = string
  description = "Use 'local' to provision local Keycloak instance, otherwise use uv-infra-bootstrap cloudformation output AccountName. Used in 'upp-config.tf' to configure account specific upp settings."
}
...
#
#
#resource "keycloak_realm" "arkiva_realm" {
#  realm       = "arkiva"
#  enabled     = true
#  login_theme = "base"
#
...
#}
#
#resource "keycloak_openid_client_scope" "arkiva_profile" {
